    ...
    <div className="min-h-screen flex items-center justify-center bg-[#e8e5e0]">
      <div className="bg-white p-10 rounded-lg shadow-xl w-full max-w-md">
        <div className="flex justify-center mb-6">
          <div className="bg-green-500 text-white rounded-full px-6 py-2 text-xl font-bold">SmartInventory</div>
        </div>
        <h2 className="text-2xl font-semibold text-center mb-1">Welcome!</h2>
        <p className="text-sm text-gray-500 text-center mb-6">Sign up to create your SmartInventory account</p>
